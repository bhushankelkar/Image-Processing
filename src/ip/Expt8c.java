...
public class Expt8c {
    BufferedImage PrewitFilterAction(BufferedImage image) {
        ...
        for(int i = 0; i<height; i++){
            for(int j = 0; j<width; j++){
                ...
                valX[0]=Math.round(valX[0]/6);
                valX[1]=Math.round(valX[1]/6);
                valX[2]=Math.round(valX[2]/6);
                valY[0]=Math.round(valY[0]/6);
                valY[1]=Math.round(valY[1]/6);
                valY[2]=Math.round(valY[2]/6);
